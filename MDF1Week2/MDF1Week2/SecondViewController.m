...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        self.title = NSLocalizedString(@"Research", @"Research");//title for tab
        self.tabBarItem.image = [UIImage imageNamed:@"first"];//image for tab
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (detailView != nil) {
        ...
        //populates my detail text field and labels with data from arrays
